propose_step_prompt = """You are solving a text-to-SQL task for a SQLite database.
...
propose_final_prompt = """You are solving a text-to-SQL task for a SQLite database.
...
value_prompt = """You are judging whether a candidate SQLite SQL query is likely to correctly answer the database question.
...
direct_sql_prompt = """You are solving a text-to-SQL task for a SQLite database.
...
decomp_repair_prompt = """You are repairing a SQLite SQL query for a text-to-SQL task.
...
3. Which filters come from the question or evidence, and do not add unsupported filters.
...
execution_value_prompt = """You are judging a candidate SQLite SQL query for a database question.
